...
public class RunnerTest {
	...
	public static void generarReporte() {
		File reportOutputDirectory = new File("target/Reporte_Cucumber_HTML");
		...
		configuration.addClassifications("Plataforma", "Android");
...
//		classificationFiles.add("application-uat.properties");
